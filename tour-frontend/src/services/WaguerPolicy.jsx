        ...
        <div className="max-w-3xl mx-auto p-6 bg-white text-gray-800">
            ...
            <section className="mb-6">
                ...
                <ul className="list-disc pl-5">
                    <li><strong>Personal Information:</strong> When you make a booking or inquire about our services, we collect
                        your name, email address, phone number, and other personal details you voluntarily provide.</li>
                    <li><strong>Usage Data:</strong> We collect information about how you use our website, including pages visited,
                        time spent on the site, and interactions with various elements of the site.</li>
                    <li><strong>Device Information:</strong> We may collect details about the device you use to access our website, 
                        including your IP address, browser type, and operating system.</li>
                    <li><strong>Location Data:</strong> With your permission, we may collect your geographical location to tailor
                        our services and provide location-based content or offers.</li>
                </ul>
                <p>
            ...
            <section className="mb-6">
                ...
                <ul className="list-disc pl-5">
                    <li><strong>To Provide Our Services:</strong> We use your information to process bookings, respond to inquiries,
                        and ensure that you have a smooth experience with Sharming Morocco Tours.</li>
                    <li><strong>To Improve Our Website and Services:</strong> Usage data helps us analyze how our website is used,
                        enabling us to improve its functionality and design.</li>
                    <li><strong>To Personalize Your Experience:</strong> We may use the information you provide to personalize your
                        interactions with us, such as offering personalized recommendations based on your preferences.</li>
                    <li><strong>To Communicate With You:</strong> We may send you important updates regarding your bookings, as well as
                    ...
                    <li><strong>For Legal and Regulatory Compliance:</strong> We may use your information to comply with legal obligations,
                        resolve disputes, or enforce our Terms and Conditions.</li>
                </ul>
            </section>
            ...
            <section className="mb-6">
                ...
                <p>
                    Email: <a href="mailto:info@sharmingmoroccotours.com" className="text-blue-600">info@sharmingmoroccotours.com</a>
                </p>
                <p>Phone: +1 (123) 456-7890</p>
                <p>Address: 1234 Travel Road, Wander City, Morocco</p>
            </section>
        </div>
    );
}
