  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="relative text-center max-w-[90%] mb-8">
        ...
        {/* Tour Overview */}
        <div className={`flex flex-col lg:flex-row gap-8 p-5 rounded-lg bg-white ${tour.promotions > 0 ? 'shadow-red-300' : 'shadow-orange-300'} shadow-md`}>
          {/* Left Section */}
        ...
        <div className="mt-12 bg-white rounded-lg p-6">
          <h3 className={`text-2xl font-semibold text-white ${tour.promotions > 0 ? 'bg-gradient-to-r from-orange-400 to-red-500' : 'bg-orange-300'} header-waguer border-b-8 border-orange-300 p-3 text-center rounded-t-lg`}>
            Tour Itinerary
          </h3>
